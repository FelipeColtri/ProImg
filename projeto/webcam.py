...
points = os.path.join(os.path.dirname(__file__), r'modelo/pts_in_hull.npy')
prototxt = os.path.join(os.path.dirname(__file__), r'modelo/colorization_deploy_v2.prototxt')
model = os.path.join(os.path.dirname(__file__), r'modelo/colorization_release_v2.caffemodel')
